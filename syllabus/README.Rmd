...
```{r echo=FALSE}
NER <- c("tyler-spangler","ACGidds","maxwell2818")
SA  <- c("bjhufstetler","anson25cheng","hrdCory")
DS  <- c("clarence0083","treypujat","mnschro6") 
