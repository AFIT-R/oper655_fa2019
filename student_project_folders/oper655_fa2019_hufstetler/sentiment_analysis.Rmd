...
```{r pressure, echo=FALSE, fig.cap="", out.width = '100%', eval = T}
...
Twitter sentiment analysis: The good the bad and the omg! (@kouloumpis2011twitter)

Sentiment analysis of twitter data (@agarwal2011sentiment)

Sentiment analysis of twitter data package (@munson2019sentiment)
