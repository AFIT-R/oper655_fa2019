...
Document summarization can traced back ti the
1950s. An important research of these days was [38] for summarizing
scientific documents. Luhn et al. in the paper "The automatic creation of literature abstracts", introduced a method to
extract sentences from the text using features such as wordand phrase frequency.
